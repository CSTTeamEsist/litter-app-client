...
public class LaunchFragmentsContract {
    ...
    // tags and ids for the main activity
    ...
    public static final int LOGIN_SCREEN_ID = 0;
    public static final int CREATE_ACCOUNT_SCREEN_ID = 1;
    public static final int USER_HOME_SCREEN_ID = 2;
